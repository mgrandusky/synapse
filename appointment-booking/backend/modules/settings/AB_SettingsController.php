...
class AB_SettingsController extends AB_Controller {
    ...
    public function index() {
        ...
        $this->candidates = $this->getCandidatesBookProduct();
    ...
    public function executeSettingsHoliday() {
        ...
        if ( $id ) {
            ...
            $this->getWpdb()->insert( 'ab_holiday', array( 'date' => $day, 'repeat_event' => intval( $repeat ) ), array( '%s', '%d' ) );
    ...
    protected function getCandidatesBookProduct(){
